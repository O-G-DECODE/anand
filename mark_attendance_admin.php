    ...
    if ($stmt) {
        ...
        if (isset($_GET['event_id'])) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['approve_all'])) {
                ...
                $stmt = $conn->prepare("SELECT COUNT(*) FROM request WHERE event_id = ? AND approve > 0");
                if ($stmt) {
                            ...
                            if ($stmt->execute()) {
                                ...
                                if ($stmt) {
                                    ...
                                    if ($stmt->execute()) {
                                        ...
                                        echo "<meta http-equiv='refresh' content='0;url=review_event_admin.php?event_id=" . urlencode($event_id) . "'>";
                                        exit();
                                    } else {
